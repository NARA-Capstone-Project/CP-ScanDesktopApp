<?php
	...
	class cict_db_users_functions{
		...
		//CREATE USER
		public function createUser($id,$username, $password, $date_created, $date_expire, $name, $phone, $role){
			...
			$stmt1 = $this->con->prepare("INSERT INTO users VALUES (?,?,?,?);");
			$stmt1->bind_param("ssss", $id, $name, $phone, $role);
